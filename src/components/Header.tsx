...
function Header({children} : props) {
  return (
    <header className="sticky h-[64px] top-0 w-full z-50 px-8 py-4 flex gap-4 items-center bg-black-2/90">
      {/* chevron */}
      ...
      {/* profile button */}
      <button className="h-[32px] flex items-center gap-2 p-[2px] bg-black shrink-0 rounded-full">
        <figure className="h-[28px] w-[28px]">
          <img
        ...
        <div className="max-w-[120px] truncate"> Aman Ghanghoriya </div>
        <div className="mr-2">
          <ArrowDownIcon />
        </div>
      </button>
