...
const Track = ({ index }: { index: number }) => {
  return (
    <div className="group">
      <div className="px-4 h-[56px] grid grid-cols-[16px_4fr_2fr_minmax(120px,_1fr)] gap-4 rounded hover:bg-black-2">
        <div className="flex items-center justify-self-end"> {index + 1} </div>
        <div className="flex items-center">
          ...
          <div className="grid grid-flow-row">
            <div> City Slump </div>
            <div className="text-sm text-gray"> Raja Kumari, DIVINE </div>
          </div>
        </div>
        <div className="flex items-center shrink-0">
          <Link to={""} className="text-sm text-gray line-clamp-1">
            {" "}
            O Bedardeya (From "Tu Jhoothi Main Makkaar"){" "}
          </Link>
        </div>
        <div className="flex items-center">
          <button className="opacity-0 group-hover:opacity-100 mr-4"> <TrackLikeIcon /> </button>  
          <div className="text-sm text-gray mr-4 grow flex justify-end"> 
             3:24
          </div>
          <button className="opacity-0 group-hover:opacity-100"> <TrackMoreIcon /> </button>  
        </div>
      </div>
    </div>
  );
